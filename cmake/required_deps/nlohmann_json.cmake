...
if (NOT DEFINED SlopeCraft_Nlohmann_json_include_dir)
    if (EXISTS ${CMAKE_BINARY_DIR}/3rdParty/nlohmann/json.hpp)
        set(SlopeCraft_Nlohmann_json_include_dir ${CMAKE_BINARY_DIR}/3rdParty/nlohmann)
    else ()
...
if (${SlopeCraft_download_njson})
    ...
    file(DOWNLOAD
        ...
        ${CMAKE_BINARY_DIR}/3rdParty/nlohmann/json.hpp
